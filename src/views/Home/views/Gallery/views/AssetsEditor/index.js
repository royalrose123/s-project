...
function AssetsEditor(props) {
  ...
  const formikConfig = getFormikConfig(props, assetInfo, assetId, dispatch, ctaOptions, setIsUploading)
      ...
      <AssetsFormik title='Asset Management' customFormikConfig={formikConfig} isResultMode={assetFormType === 'results'} {...props}>
        <>
          ...
          <AssetsTab assetViewType={assetViewType} canViewAssetResultPage={canViewAssetResultPage}>
            <Route exact sensitive path={`/home/gallery/edit/${assetId}/info`}>
              <AssetsForm filterOptions={filterOptions} isUploading={isUploading} />
            </Route>
            {canViewAssetResultPage && (
              <Route exact sensitive path={`/home/gallery/edit/${assetId}/results`}>
...
AssetsEditor.propTypes = propTypes

export default hot(AssetsEditor)
